$(document).ready(function () {
  ...
  $(document).on("click",".edit-address", function(e){
    ...
    jQuery.ajax({
      type: "POST",
      url: "http://localhost/Tatvasoft-PSD-TO-HTML/HelperLand/?controller=Users&function=getUserAddress",
      datatype: "json",
      data: {addid:id},
      success: function (data) {
        console.log(data);
  ...
  $(document).on("click",".delete-address", function(e){
    ...
    if(confirm("Are you sure??")){
      ...
      jQuery.ajax({
        type: "POST",
        url: "http://localhost/Tatvasoft-PSD-TO-HTML/HelperLand/?controller=Users&function=DeleteUserAddress",
        datatype: "json",
        data: {addid:id},
        success: function (data) {
          var obj = JSON.parse(data);
