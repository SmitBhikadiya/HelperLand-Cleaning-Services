             ...
             <div class="search-row">
                 ...
                 <div class="search-col form-group">
                     <select class="form-select" aria-label="Default select example">
                         ...
                         <option value="0">David Bough</option>
                     </select>
                 </div>
                 <div class="search-col form-group">
                     <select class="form-select" aria-label="Default select example">
                         <option selected>Service Service Provider</option>
                         <option value="0">Lyum Watson</option>
                     </select>
                 </div>
                 <div class="search-col form-group">
                     <select class="form-select" aria-label="Default select example">
                 ...
                 <div class="search-col div-date">
                     ...
                     <input type="text" class="form-control" placeholder="From Date" title="yyyy-mm-dd">
                 </div>
                 <div class="search-col div-date">
                    <img src="static/images/admin-calendar.png" alt="">
                    <input type="text" class="form-control" placeholder="To Date" title="yyyy-mm-dd">
                 </div>
